...
2. `dry_run = 1`（既定）、`force_date = 2026-07-05` を入れて実行 → **投稿されず、本文がログに表示**されるだけ。中身を確認。
3. 実際に1本だけ自分宛に試したいときは、`CHATWORK_ROOM_ID` を一時的に**自分のマイチャット等のルームID**にし、`dry_run = 0`、`force_date = 2026-07-05` で実行 → 自分にだけ届く。
...
| 日付(JST 20:00) | 本文 |
|---|---|
| 2026-07-05 | posts/2026-07-05_week1.md（最初の仕事） |
| 2026-07-12 | posts/2026-07-12_week2.md（すり合わせ） |
| 2026-07-19 | posts/2026-07-19_week3.md（情報は全部渡す） |
| 2026-07-26 | posts/2026-07-26_week4.md（調べもの道具＝この配布） |
